<?php
    ...
    class UsuarioBD
    {
        ...
        public function registrarUsuario($newUser, $conexion)
        {
            ...
            $consulta->bind_param("sssisiss", $newUser->getNickName(), $passwordSEC, $newUser->getEmail(), $newUser->getEdad(), $newUser->getLink(), $verify, $newUser->getNombre(), $newUser->getApellido());
            $consulta->execute();
